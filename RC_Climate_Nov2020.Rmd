...
## Update RC Climate data with Nov. 2020 download

### Climate Data

```{r}

# previous RC climate compile, Aug 2020
compiled_RC_climate_Aug2020 <- readr::read_csv(file = "Climate_RC_Aug2020/compiled_Climate_RC_Aug2020.csv", 
                                       col_types = cols(Date = col_character(), .default = col_double())) %>% 
  dplyr::mutate(Date = lubridate::ymd_hms(Date))

compiled_RC_Climate_Nov2020 <- compile_climate_data("Climate_RC_Nov2020", prev_compile = compiled_RC_climate_Aug2020, written_file_name = "compiled_Climate_RC_Nov2020.csv")
...
# previous RC ATM compile, Aug 2020
compiled_RC_ATM_Aug2020 <- readr::read_csv(file = "Atm_RC_Aug2020/compiled_ATM_RC_Aug2020.csv", 
                                       col_types = cols(Date = col_character(), .default = col_double())) %>% 
  dplyr::mutate(Date = lubridate::ymd_hms(Date))

compiled_ATM_Climate_Nov2020 <- compile_atm_data("Atm_RC_Nov2020", prev_compile = compiled_RC_ATM_Aug2020, written_file_name = "compiled_Atm_RC_Nov2020.csv")
...
```{r}
compiled_ATM_Climate_RC_Nov2020 <- dplyr::left_join(compiled_RC_Climate_Nov2020, compiled_ATM_Climate_Nov2020, by = "Date") 

compiled_ATM_Climate_RC_Nov2020 %>% 
  dplyr::mutate(Date = as.character(Date)) %>% 
  readr::write_csv("Climate_RC_Nov2020/compiled_ATM_Climate_RC_Nov2020.csv")
```
